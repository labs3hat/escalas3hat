  ...
  LOOP
    ...
    FOR v_day IN 0..6 LOOP
      ...
      IF v_slot_type_val = 'day_off' THEN
        ...
        VALUES (v_schedule_id, v_emp.id, v_dow, '00:00'::TIME, 'day_off');
      ...
      ELSE
        ...
        v_current_time := COALESCE(v_entrada_real, '08:00'::TIME);
        v_exit_time := COALESCE(v_exit_time, '22:00'::TIME);

        WHILE v_current_time < v_exit_time LOOP
          INSERT INTO schedule_slots (schedule_id, employee_id, day_of_week, slot_time, slot_type)
          VALUES (v_schedule_id, v_emp.id, v_dow, v_current_time, v_slot_type_val);
