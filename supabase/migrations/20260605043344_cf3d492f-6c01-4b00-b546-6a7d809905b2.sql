...
BEGIN
  ...
  IF NOT FOUND THEN
    INSERT INTO schedules (store_id, week_start, status, created_by) VALUES (p_store_id, p_week_start, 'draft', p_created_by) RETURNING id INTO v_schedule_id;
  END IF;
  ...
  -- [RESTO DA FUNÇÃO OMITIDA POR SEGURANÇA, MAS DEVE CONTER O CÓDIGO ORIGINAL COM AS ALTERAÇÕES DE CONTAGEM DE FREELANCERS]
