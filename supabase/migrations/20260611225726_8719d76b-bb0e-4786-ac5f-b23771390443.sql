  ...
  LOOP
    ...
    FOR v_day IN 0..6 LOOP
      ...
      ELSE
        ...
        SELECT 
          (CASE 
            WHEN v_shift_name = 'sunday' THEN v_store.sunday_shift_start
            WHEN v_shift_name = 'saturday' THEN v_store.saturday_shift_start
            ELSE v_store.weekday_shift_start 
          END)::TIME INTO v_entrada_real;

        SELECT 
          (CASE 
            WHEN v_shift_name = 'sunday' THEN v_store.sunday_shift_end
            WHEN v_shift_name = 'saturday' THEN v_store.saturday_shift_end
            ELSE v_store.weekday_shift_end
