CREATE OR REPLACE FUNCTION public.generate_base_schedule(p_store_id uuid, p_week_start date, p_created_by uuid DEFAULT NULL::uuid)
 ...
 SECURITY DEFINER
AS $function$
-- v21: removido efeito colateral que gravava preferred_day_off em employees
-- (gerador nao escreve em cadastro; preferred_day_off = restricao da planilha apenas)
DECLARE
  v_schedule_id         UUID;
  v_store               RECORD;
  v_emp                 RECORD;
