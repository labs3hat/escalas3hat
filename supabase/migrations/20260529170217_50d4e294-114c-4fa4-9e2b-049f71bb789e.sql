CREATE OR REPLACE FUNCTION public.generate_base_schedule(p_store_id uuid, p_week_start date, p_created_by uuid DEFAULT NULL::uuid)
 ...
 SECURITY DEFINER
AS $function$
-- v16: respeita monthly_sunday_off (domingo fixo do mês tem prioridade sobre R17)
DECLARE
  v_schedule_id         UUID;
  v_store               RECORD;
  v_emp                 RECORD;
  ...
  v_folga_day2          INT;
  v_folga_sunday        DATE;
  v_fixed_sunday        DATE;  -- v16: domingo fixo do mês
  v_found               BOOLEAN;
  v_found2              BOOLEAN;
  v_candidate_day       INT;
...
BEGIN
  ...
  LOOP
    ...
    -- v16: domingo fixo definido na geração mensal tem prioridade
    ...
    -- Folga 1: fixed > preferred > rotativa
